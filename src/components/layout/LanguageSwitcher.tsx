...
import { useLanguage, languageLabels } from "@/src/libs/animation/hooks/useLanguage";
import type { SupportedLanguage } from "@/src/libs/animation/hooks/useLanguage";
...
export function LanguageSwitcher() {
  ...
  const current =
    languageLabels[currentLanguage as SupportedLanguage] ?? languageLabels["en"];
